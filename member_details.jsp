                ...
                <div class="row">
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <!-- ***** Menu Start ***** -->
                            <ul class="nav">
                                <li class="scroll-to-section"><a href="GM_Home.jsp">Home</a></li>
                                <li class="scroll-to-section"><a class="active" href="member_details.jsp">Group Members</a></li>
                        ...
                        <center>
                            <div class="ex1">
                                <table id="customers">
                                    ...
                                    %>
                                    <tr>
                                    <form action="member_approve.jsp" method="get">
                                        ...
                                        <td><input style="background-color: transparent; border: none; color: #000" name="email" size="33" value="<%=rs.getString("email")%>" type="text" readonly=""></td>
                                        <td class="center"><%=rs.getString("dob")%> </td>
                                        <td class="center"><%=rs.getString("address")%> </td>
                                        <td class="center"><%=rs.getString("grp")%> </td>
                                        <td class="center"><%=rs.getString("status")%> </td>
                                        <td><i><button type="submit" class="btn btn-success">Approve</button></i></td>
                                    </form>
                                    </tr>
                                    <%                                        }
                                        } catch (Exception ex) {
