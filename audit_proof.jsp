                    ...
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <ul class="nav">
                                ...
                                <li class="scroll-to-section"><a class="active" href="audit_proof.jsp">Audit Proof</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-heading">
                            <center><h2><em>Auditing Proof</em></h2></center>
                        </div>   
                        <center>
                            <div class="ex1">
                                <table id="customers">
                                    ...
                                    <%
                                        ...
                                        try {
                                            ResultSet rs = st.executeQuery("Select * from audit_request where uid  ='" + uid + "' AND status = 'Verified' ");
                                            while (rs.next()) {
                                    %>
                                    <tr>
