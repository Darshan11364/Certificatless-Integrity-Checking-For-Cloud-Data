                ...
                <div class="row">
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <!-- ***** Menu Start ***** -->
                            <ul class="nav">
                                <li class="scroll-to-section"><a class="active" href="GM_Home.jsp">Home</a></li>
                                <li class="scroll-to-section"><a href="member_details.jsp">Group Members</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-heading">
                            <center><h2><em>Welcome Group Manager!</em></h2></center>
                        </div>
                        <center><img src="images/gmhome.jpg" /></center>
                    </div>
                </div>
            </div>
        </div>
