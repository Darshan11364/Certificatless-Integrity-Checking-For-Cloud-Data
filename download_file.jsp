                            ...
                            <div class="row">
                                ...
                                <%
                                    ...
                                    try {
                                        ...
                                        ResultSet rs = st1.executeQuery("Select * from request where uid = '" + uid + "' AND fid = '" + fid + "' AND time ='" + time + "' AND dkey = '" + dkey + "' AND status = 'Approved' ");
                                        if (rs.next()) {
                                            ResultSet rs1 = st.executeQuery("Select * from data_files where id = '" + fid + "'");
                                            if (rs1.next()) {
                                %>
                                <div class="col-lg-6">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <fieldset>
                                                ...
                                                <label style="float: left"><b>File Name:</b></label>
                                                <input type="text" name="filename" readonly="" value="<%=rs1.getString("filename")%>" />
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-12">
                                            <fieldset>
                                                <label style="float: left"><b>File Content:</b></label>
                                                <textarea style=" height: 170px;resize: none" readonly="" name="data"><%=rs1.getString("enc_data")%></textarea>
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-12">
                                            <fieldset>
                                                <button type="submit" style="float: left" id="form-submit" class="main-button ">Download</button>
                                                <br><p style="float: left">&nbsp;&nbsp;&nbsp;&nbsp;<a href="update_file.jsp?fid=<%=rs1.getString("id")%>&fname=<%=rs1.getString("filename")%>" class="btn btn-primary btn-lg">Update</a></p>
                                            </fieldset>
                                        </div>
                                    </div>
                                </div>
                                <%}
                                            ...
                                            response.sendRedirect("download.jsp?Incorrect_key_values");
                                        }
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
                                    }
