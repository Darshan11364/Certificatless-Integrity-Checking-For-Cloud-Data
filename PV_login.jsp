                    ...
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <ul class="nav">
                                ...
                                <li class="scroll-to-section"><a class="active" href="PV_login.jsp">Public Verifier</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.25s">
                        <form id="contact" action="pv" method="post">
                            <div class="row">
                                <div class="col-lg-6 offset-lg-3">
                                    <div class="section-heading">
                                        <h2>Public Verifier<em> Login</em></h2>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <img src="images/dologin1.jpg" width="350" height="300">
                                </div>
                                <div class="col-lg-6">
                                    <div class="row">
                                        <div class="col-lg-12">
