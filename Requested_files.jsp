                    ...
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <ul class="nav">
                                ...
                                <li class="scroll-to-section"><a class="active" href="Requested_files.jsp">Requested Files</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-heading">
                            <center><h2><em>Requested Files</em></h2></center>
                        </div>   
                        <center>
                            <div class="ex1">
                                <table id="customers">
                                    ...
                                    <%
                                        ...
                                        try {
                                            ResultSet rs = st.executeQuery("SELECT * FROM request WHERE doid ='" + uid + "' AND status = 'waiting' ");
                                            while (rs.next()) {
                                    %>
                                    <tr>
                                        ...
                                        <td><a href="approve_filereq.jsp?fid=<%=rs.getString("fid")%>&time=<%=rs.getString("time")%>&mail=<%=rs.getString("umail")%>" class="btn btn-success">Approve</a></td>
                                        <td><a href="reject_filereq.jsp?fid=<%=rs.getString("id")%>" class="btn btn-danger">Reject</a></td>
                                    </tr>
                                    <%                                        }
                                        } catch (Exception ex) {
                                            ex.printStackTrace();
