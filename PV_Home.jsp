                ...
                <div class="row">
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <!-- ***** Menu Start ***** -->
                            <ul class="nav">
                                <li class="scroll-to-section"><a class="active" href="PV_Home.jsp">Home</a></li>
                                <li class="scroll-to-section"><a href="Auditing_reqeust.jsp">Auditing Request</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-heading">
                            <center><h2><em>Welcome Public Verifier!</em></h2></center>
                        </div>
                        <center><img src="images/tpahome.jpg" /></center>
                    </div>
                </div>
            </div>
        </div>
