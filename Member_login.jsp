            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.25s">
                        <form id="contact" action="member_signin.jsp" method="post">
                            <div class="row">
                                <div class="col-lg-6 offset-lg-3">
                                    <div class="section-heading">
                                        <h2>Group Member<em> Login</em></h2>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <img src="images/userlogin.jpg" width="350" height="300">
                                </div>
                                <div class="col-lg-6">
                                    <div class="row">
                                        <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset>
                                                ...
                                                <input type="text" name="pkey" id="name" placeholder="Enter Private Key" autocomplete="off" required>
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-12">
                                            <fieldset>
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset>
                                                ...
                                                <br><p style="float: left"><a href="member_signup.jsp" id="form-submit" class="btn btn-link">Register!</a></p>
                                            </fieldset>
                                        </div>
                                    </div>
                                </div>
